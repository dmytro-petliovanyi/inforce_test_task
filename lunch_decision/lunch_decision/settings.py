...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_REFRESH_SILENT_UPDATE': False,
    'SLIDING_TOKEN_REFRESH_SILENT_UPDATE_TTL': timedelta(days=1),
    'SLIDING_TOKEN_REFRESH_SILENT_UPDATE_RESET_EXP_ON_REFRESH': False,
